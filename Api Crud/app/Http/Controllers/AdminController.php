...
//* <-----------------------This Route Provide The Information Of Login User------------------------------>
     ...
     * @return \Illuminate\Http\Response
     */
    //* <-----------------------This Route Update The Existing Admin Name Email Passsword of Selected User ------------------------------>
    public function update(Request $request)
    {
        ...
        if(!empty($data))
        {
            ...
            $data -> update($user);
            return response()->json([
                'message'=>'Admin Upated Successful'
            ],200);
        }
        else{
            return response()->json([
    ...
    public function updateuser(Request $request,$id)
    {
        ...
        if(!empty($data))
        {
            ...
            {
                return response()->json([
                    'message'=>'You Have No Permission to Change this User'
                ],401);
            }
            else{
                return response()->json([
    ...
    public function destroy()
    {
     ...
     public function destroyuser($id)
     {
      ...
      //* <-----------------------This Route Logout the Current Admin ------------------------------>
